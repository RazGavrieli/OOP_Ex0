...
public class Ex0_main {
    public static Long ID0=209380922L, ID1 = 316329069L, ID2 = 2076409806L;
    public static void main(String[] ar) {
       ...
       // String callFile = "C:\\Users\\razga\\IdeaProjects\\OOP_2021\\out\\Exx_TestCalls.csv"; //
       // Simulator_A.initData(stage, callFile);  // init the simulator data: {building, calls}.
        ...
        //ElevatorAlgo ex0_alg = new SimpleAlgo(Simulator_A.getBuilding());
        // ElevatorAlgo ex0_alg = new egcAlgo(Simulator_A.getBuilding());
